...
document.querySelector('.js-number-of-item').innerHTML = `${cartQuantity} item${cartQuantity !== 1 ? 's' : ''}`;
//document.querySelector('.js-number-of-item').innerHTML=`${cartQuantity} items`;
...
export function renderOrderSummary(){
    ...
    cart.forEach((cartItem)=>{
        ...
        // delivery date from top  caluclator 
    ...
    function deliveryOptionsHtml(matchingProduct,cartItem){
        ...
        deliveryOptions.forEach((deliveryOption)=>{
            ...
            const isChecked= deliveryOption.id===cartItem.deliveryOptionId; //from here gol hogya 
            html+=    
            `
    ...
    //this will add the whole summary 
    document.querySelector('.js-order-summary').innerHTML=cartSummaryHTML;

    //to delete the item from cart.js and checkout page
